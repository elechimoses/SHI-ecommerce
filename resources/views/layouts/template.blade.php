...
<body>
    ...
    <div class="offcanvas-menu-wrapper">
        ...
        <div class="offcanvas__nav__option">
            <a href="#" class="search-switch"><img src="template-assets/img/icon/search.png" alt=""></a>
            <a href="#"><img src="template-assets/img/icon/heart.png" alt=""></a>
            <a href="#"><img src="template-assets/img/icon/cart.png" alt=""> <span>0</span></a>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-3">
                    <div class="header__logo">
                        <a href="./"><img src="template-assets/img/logo.png" alt=""></a>
                    </div>
                </div>
